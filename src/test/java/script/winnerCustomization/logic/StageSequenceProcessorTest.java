...
class StageSequenceProcessorTest {
    ...
    @Test
    void realStageIgnoresDuplicateInUsesStickyOutAndReopensAfterOut() {
        ...
        var result = processor.process(List.of(
                detection(1, "AA1111", 1001, 90, base),
                detection(2, "AA1111", 1001, 100, base.plusSeconds(2)),
                detection(3, "AA1111", 1002, 250, base.plusSeconds(10)),
                detection(4, "AA1111", 1002, 260, base.plusSeconds(12)),
                detection(5, "AA1111", 1001, 90, base.plusSeconds(20))
    ...
    @Test
    void partialOutIsRecordedAndClosesActiveTransitional() {
        var config = TestConfigFactory.standardConfig();
        ...
        var result = processor.process(List.of(
                ...
                detection(3, "BB2222", 2001, null, base.plusSeconds(5)),
                detection(4, "BB2222", 1002, 200, base.plusSeconds(20))
    ...
    @Test
    void sequenceCloseKeepsIncompleteRealAndRemovesIncompleteTransitionalWhenConfigured() {
        var config = TestConfigFactory.standardConfig();
        config.setSequenceCloseTimeoutMinutes(1);
        LocalDateTime base = LocalDateTime.of(2026, 3, 23, 15, 0);
        var result = processor.process(List.of(
