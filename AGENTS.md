...
- TECHNICAL_SPEC.md should be developers oriented, and should contain a description of all classes, interfaces and methods and interactions between them. 
...
- Take real data from sql file in the root folder and use it to make unit testes for all the possible cases.
